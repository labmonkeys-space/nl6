...
-syslog-transport <t>             # [seed]   udp (default) | tcp (RFC 6587). TCP is one connection PER DEVICE with capped-backoff reconnect and keepalives; per-device via REST `syslog.transport`.
