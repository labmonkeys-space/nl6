...
|---|---|---|
| `3.40.1` | `.4.0.1` | refused, first arc 3 is not representable |
...
Nothing that ships with nl6 changes on the wire: all 5,651 distinct OIDs across the resource files and trap catalogs encode to exactly the same bytes as before.
